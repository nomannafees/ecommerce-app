...
@section('content')
    ...
    <div class="flex flex-col lg:flex-row gap-6 px-3 sm:px-12 py-6">
        ...
        <aside class="w-full lg:w-1/5 bg-white p-5 rounded-xl shadow h-fit hidden lg:block overflow-visible">
            ...
            <form method="GET" action="{{ route('categories') }}" id="filterForm" class="space-y-4 border-t border-gray-200 pt-4">
        ...
        <div class="w-full lg:w-4/5">
            ...
            <!-- MOBILE HORIZONTAL SCROLLING FILTER BUTTONS (Dropdown right below buttons) -->
            <div class="mb-6 block lg:hidden bg-gray-50 border border-gray-200 rounded-xl p-3 shadow-sm space-y-2 relative">
                ...
                <!-- ================= MOBILE DROPDOWNS (BELOW SECTION) ================= -->
            ...
            <div id="productGrid" class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-3 mb-10 md:mb-5 sm:gap-6">
                @forelse($records as $product)
                    ...
                    <div
                        class="relative bg-white rounded-xl sm:rounded-xl shadow-sm border border-gray-200 overflow-hidden hover:shadow-xl transition duration-300 group flex flex-col h-full w-full">
                        ...
                        <a href="{{ route('product.detail', $product->slug) }}{{ request('color') ? '?color='.request('color') : '' }}"
                           class="block z-10 flex flex-col h-full">
                            <div class="bg-gray-100 overflow-hidden relative h-42 xs:h-44 sm:h-55 md:h-50 lg:h-55">
                                @if(!empty($imagePath))
                ...
                @empty
                    <div
                        class="col-span-full flex flex-col items-center justify-center text-center py-16 px-4 bg-gray-50/50 rounded-2xl border border-dashed border-gray-200">
                        <div
                            class="w-16 h-16 bg-gray-100 text-gray-400 rounded-full flex items-center justify-center mb-4 shadow-inner">
