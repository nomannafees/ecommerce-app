...
@section('content')
    ...
    <div class="min-h-[80vh] flex items-center justify-center px-4 py-8">
        ...
        <div class="max-w-md w-full bg-white rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-gray-100 p-8 md:p-10 text-center transition-all duration-300 hover:shadow-[0_8px_30px_rgb(0,0,0,0.08)]">
            ...
            <p class="text-sm leading-relaxed text-gray-500 max-w-sm mx-auto mb-6">
                We have received your order and our team will contact you soon regarding delivery details.
            </p>

            <!-- NEW: Blinking Order Processing Alert Box -->
            <div class="bg-amber-50/80 rounded-xl p-4 border border-amber-200/60 mb-4 flex items-start gap-3 text-left">
                <div class="relative flex items-center justify-center shrink-0 mt-0.5">
                    <!-- Blinking / Pulse outer ring -->
                    <span class="animate-ping absolute inline-flex h-full w-full rounded-lg bg-amber-400 opacity-75"></span>
                    <!-- Main Icon Box -->
                    <div class="relative p-2 bg-amber-100 text-amber-700 rounded-lg">
                        <i class="fa-solid fa-arrows-rotate text-sm animate-spin"></i>
                    </div>
                </div>
                <div>
                    ...
                    <p class="text-xs text-amber-700/90 mt-0.5 leading-normal">
            ...
            <div>
                <a href="{{ route('frontend.orders.index') }}"
                   class="inline-flex items-center mt-3 gap-2 text-sm font-medium text-emerald-700 hover:text-emerald-800 transition-colors duration-200">
