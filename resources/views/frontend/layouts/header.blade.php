        ...
        <div class="container mx-auto px-4 sm:px-6 lg:px-8 py-2 sm:py-2 flex items-center justify-between">
            ...
            <div class="relative w-64 shrink-0"
                ...
                <div class="relative group/dropdown inline-block w-full">
                    ...
                    <div class="hidden group-hover/dropdown:flex absolute left-0 top-full z-50 [--dd-h:38vw] md:[--dd-h:25.2vw]"
                         style="margin-top: 0px !important;">

                        <!-- LEVEL 1: Main Categories Box -->
                        <div class="w-[16rem] bg-white h-[var(--dd-h)] overflow-y-auto custom-scrollbar p-2">
                            ...
                            @if($subCategories->count() > 0)
                                <!-- LEVEL 2: Sub Categories Box -->
                                    <div x-show="activeMain === {{ $mainCat->id }}"
                                         ...
                                         class="absolute left-0 top-0 w-[16rem] bg-white h-[var(--dd-h)] border-r border-gray-200 p-2 z-50 overflow-y-auto custom-scrollbar">
                                    ...
                                    @foreach($subCategories as $subCat)
                                        ...
                                        @if($childCategories->count() > 0)
                                            <div
                                                    ...
                                                    class="absolute left-64 top-0 bg-white w-[16rem] h-[var(--dd-h)] p-2 z-50 overflow-y-auto custom-scrollbar">
