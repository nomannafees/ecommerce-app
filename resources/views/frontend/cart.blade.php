...
@section('content')
    ...
    <div class=" pb-10 pt-6 min-h-[49vh]">
...
@push('scripts')
    <!-- Agar SweetAlert2 already aapki main layout (layouts/app) mein globally include hai,
         to neeche wali line hata dein — duplicate load hone se koi masla nahi hota,
         lekin agar pehle se load hai to isay hata dena zyada saaf tareeqa hai. -->
    <script src="https://cdn.jsdelivr.net/npm/sweetalert2@11"></script>

    <script>
        $(document).ready(function () {

            // SweetAlert2 Toast Mixin (top-right corner, auto-dismiss)
            ...
            $(document).on('click', '.deleteCart', function (e) {
                ...
                $.ajax({
                        ...
                        if (response.status === true || response.status === "true") {
                            ...
                            cartItemRow.fadeOut(250, function () {
                                ...
                                if ($('.cart-item').length === 0) {
                                    ...
                                    // Hide cart layout (grid + summary)
                                    $('.cart-grid-wrapper').addClass('hidden');
                    ...
                    error: function (xhr) {
                        ...
                        Toast.fire({
                            icon: 'error',
                            title: 'Something went wrong while removing item.'
                        });
                    }
                });
            });
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (
                            ...
                            Toast.fire({
                                icon: 'error',
                                title: response.message || 'Unable to update quantity.'
                            });
                        }
                    },
