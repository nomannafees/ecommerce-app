    ...
    <div class="mx-auto p-6">
        <div class="bg-white shadow-sm rounded-2xl border border-gray-200 overflow-hidden p-6">
            ...
            <div class="flex items-center justify-between pb-6 border-b border-gray-200 mb-6">
                ...
                <a href="{{ route('featuredbanners.index') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-sm font-medium transition duration-200">
        ...
        <!-- Update Form -->
            <form action="{{ route('featuredbanners.update', $featuredBanner->id) }}" method="POST">
            @csrf
            @method('PUT')

            <!-- Hidden inputs to retain values -->
                <input type="hidden" name="name" value="{{ $featuredBanner->name }}">
                <input type="hidden" name="description" value="{{ $featuredBanner->description }}">
                <input type="hidden" name="button_name" value="{{ $featuredBanner->button_name }}">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch">
                            ...
                            <div class="p-4 bg-gray-50/50 border border-gray-200 rounded-xl flex items-center gap-4">
                                <div class="w-16 h-16 shrink-0 rounded-lg overflow-hidden border border-gray-200 bg-white">
                                    @if($featuredBanner->image)
                                        <img src="{{ asset('storage/' . $featuredBanner->image) }}" class="w-full h-full object-cover">
                                    @else
                            ...
                            <div class="p-4 bg-gray-50/50 border border-gray-200 rounded-xl flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm font-bold text-gray-800 mt-0.5 truncate">{{ $featuredBanner->name ?? 'No Name Provided' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="p-4 bg-gray-50/50 border border-gray-200 rounded-xl flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-gray-700 mt-0.5 line-clamp-2">{{ $featuredBanner->description ?? 'No Description Provided' }}</p>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl shadow-2xs">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer shrink-0">
                                    ...
                                    <input type="checkbox" name="is_title" value="1" class="sr-only peer" {{ $featuredBanner->is_title == 1 ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl shadow-2xs">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer shrink-0">
                                    ...
                                    <input type="checkbox" name="is_image" value="1" class="sr-only peer" {{ $featuredBanner->is_image == 1 ? 'checked' : '' }}>
                                    <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-emerald-600 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                                </label>
                            </div>
                            ...
                            <div class="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl shadow-2xs">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer shrink-0">
                                    ...
                                    <input type="checkbox" name="is_description" value="1" class="sr-only peer" {{ $featuredBanner->is_description == 1 ? 'checked' : '' }}>
                                    <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-emerald-600 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                                </label>
                            </div>
