    ...
    <div class="mx-auto p-6">
        <div class="bg-white shadow-sm rounded-2xl border border-gray-200 overflow-hidden p-6">
            ...
            <div class="flex items-center justify-between pb-6 border-b border-gray-200 mb-6">
                <h2 class="text-2xl font-bold text-gray-800">Slider Display Settings</h2>
                <a href="{{ route('sliders.index') }}" class="inline-flex items-center gap-2 px-4 py-2 bg-gray-100 hover:bg-gray-200 text-gray-700 rounded-xl text-sm font-medium transition duration-200">
        ...
        <!-- Update Form -->
            ...
            <!-- Hidden inputs -->
                <input type="hidden" name="heading" value="{{ $slider->heading }}">
                <input type="hidden" name="description" value="{{ $slider->description }}">

                <div class="space-y-6">

                    <!-- TOP SECTION: Slider Information -->
                    <div>
                        <h3 class="text-xs font-bold uppercase tracking-wider text-gray-700 mb-4">Slider Information</h3>
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 items-stretch">
                            ...
                            <div class="p-4 bg-gray-50/50 border border-gray-200 rounded-xl flex items-center gap-4">
                                ...
                                <div>
                                    ...
                                    <p class="text-xs text-gray-500 mt-1">Frontend preview image for this slide.</p>
                                </div>
                            </div>
                            ...
                            <div class="p-4 bg-gray-50/50 border border-gray-200 rounded-xl flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <span class="block text-xs font-semibold text-gray-400 uppercase tracking-wide">Heading</span>
                                    <p class="text-sm font-bold text-gray-800 mt-0.5 truncate">{{ $slider->heading ?? 'No Heading Provided' }}</p>
                                </div>
                            </div>
                            ...
                            <div class="p-4 bg-gray-50/50 border border-gray-200 rounded-xl flex items-start gap-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    ...
                                    <p class="text-sm text-gray-700 mt-0.5 line-clamp-2">{{ $slider->description ?? 'No Description Provided' }}</p>
                                </div>
                            </div>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl shadow-2xs">
                                <div class="flex items-center gap-3">
                                    ...
                                    <div>
                                        ...
                                        <span class="text-xs text-gray-500">Heading text</span>
                                    </div>
                                </div>
                                <label class="relative inline-flex items-center cursor-pointer shrink-0">
                                    <input type="hidden" name="is_title" value="0">
                                    <input type="checkbox" name="is_title" value="1" class="sr-only peer" {{ $slider->is_title == 1 ? 'checked' : '' }}>
                            ...
                            <div class="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl shadow-2xs">
                                ...
                                <label class="relative inline-flex items-center cursor-pointer shrink-0">
                                    ...
                                    <input type="checkbox" name="is_image" value="1" class="sr-only peer" {{ $slider->is_image == 1 ? 'checked' : '' }}>
                                    <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-emerald-600 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                                </label>
                            </div>

                            <!-- Switch 3: Show Description -->
                            <div class="flex items-center justify-between p-4 bg-white border border-gray-200 rounded-xl shadow-2xs">
                                <div class="flex items-center gap-3">
                                    <div class="w-9 h-9 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center text-base font-bold shrink-0">
                                        <i class="fa-solid fa-align-left"></i>
                                ...
                                <label class="relative inline-flex items-center cursor-pointer shrink-0">
                                    ...
                                    <input type="checkbox" name="is_description" value="1" class="sr-only peer" {{ $slider->is_description == 1 ? 'checked' : '' }}>
                                    <div class="w-11 h-6 bg-gray-200 rounded-full peer peer-checked:bg-emerald-600 peer-checked:after:translate-x-full after:content-[''] after:absolute after:top-0.5 after:left-[2px] after:bg-white after:border-gray-300 after:border after:rounded-full after:h-5 after:w-5 after:transition-all"></div>
                                </label>
                            </div>
